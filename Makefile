...
BUILDUSER := `whoami`
LDFLAGSSTRING :=-X github.com/DeckerSU/lightwalletd/common.Version=$(VERSION)
LDFLAGSSTRING +=-X github.com/DeckerSU/lightwalletd/common.GitCommit=$(GITCOMMIT)
LDFLAGSSTRING +=-X github.com/DeckerSU/lightwalletd/common.Branch=$(BRANCH)
LDFLAGSSTRING +=-X github.com/DeckerSU/lightwalletd/common.BuildDate=$(BUILDDATE)
LDFLAGSSTRING +=-X github.com/DeckerSU/lightwalletd/common.BuildUser=$(BUILDUSER)
