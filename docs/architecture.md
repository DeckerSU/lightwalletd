...
```
$ git clone https://github.com/DeckerSU/lightwalletd
$ cd lightwalletd
...
The API is specified in [Protocol Buffers](https://developers.google.com/protocol-buffers/) and implemented using [gRPC](https://grpc.io). You can find the exact details in [these files](https://github.com/DeckerSU/lightwalletd/tree/master/walletrpc).
